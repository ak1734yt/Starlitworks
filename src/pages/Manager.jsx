      ...
      <aside className="w-64 border-r border-white/10 bg-[#0A0A0A] p-6 flex flex-col">
        ...
        <nav className="space-y-2 flex-1">
          {[
            ...
            { id: 'portfolio', icon: Layout, label: 'Portfolio Manager' },
            { id: 'site-editor', icon: Settings, label: 'SEO & Site Manager' },
                ...
                <table className="w-full text-left text-sm min-w-[800px]">
                  <thead className="bg-white/5 border-b border-white/5">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Due Amount</th>
                      <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
